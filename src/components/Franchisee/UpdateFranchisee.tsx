...
const UpdateFranchisee = (props) => {

    const {setfranchiseeData, franchiseeData, email, name, phone, setphone, setemail, setname, Id,  setBgColor, setDisplay4, setevents} = props
    ...
    const update = (e)=>{
        ...
        for(let i of franchiseeData){
            if(i.franchisee_id == Id){
                let index = franchiseeData.indexOf(i)
                // console.log(i)
                franchiseeData.splice(index, 1 , {
                    franchisee_id: Id,
            email: email,
        ...
        axios.put(baseURL+'franchisee/update', {
            franchisee_id: Id,
            email: email,
            franchisee_name: name,
            phone_no: phone
...
export default UpdateFranchisee
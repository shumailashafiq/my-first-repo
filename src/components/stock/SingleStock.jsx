...
//     const {singleStockData,setBgColor,setDisplay2,setevents}=props
//     console.log(singleStockData)
//     // const {singleStock,setBgColor,setevents,setDisplay2}=props
...
//                     </thead>
//                     <tbody>
//                         {singleStockData.length > 0 ?(
//                             singleStockData.map((stock, index) => (
//                                 <tr key={index}>

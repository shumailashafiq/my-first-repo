    ...
    <DefaultLayout>
        ...
        <div className={`h-full w-full flex justify-center items-center z-20 ${display} `}>
            ...
            />
                ...
                <div className={`h-1/2 w-1/2 flex justify-center  items-center fixed z-999 top-[10%] left-[30%] ${display2} `}>
              ...
              <button onClick={AddCategories} className='p-3 px-4 shadow-md shadow-black  bg-blue-500 rounded fixed  text-white bottom-[35px] right-[35px] z-99 text-3xl'>+</button>
            <div className={`rounded-sm border  border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1 ${bgColor} ${events}`}>
                <div className="max-w-full overflow-x-auto">
                    ...
                    {Category.length < 1 ? (<CategoryLoad/>) :
                    <tbody>
                        ...
                        <tr key={key}>
                            <td className="border-b border-[#eee] py-5 px-5  dark:border-strokedark xl:pl-11 flex gap-2 items-center">
                                <div className='h-[50px] w-[70px] relative overflow-hidden rounded'>
                                    <img className=' h-[50px] w-[70px] object-cover' src={baseUrl+category.image} alt="" />
                                </div>
                            ...
                            <div className="flex items-center space-x-3.5">
                                <button onClick={()=>singleCategory(key)} className="hover:text-primary">
                            ...
                            <div className="flex items-center space-x-3.5">
                                ...
                                <button onClick={()=>deleteHandler(category.category_id, key)} className="hover:text-primary">
                                <svg
                                ...
                                <button  onClick={()=>UpdateHandler(category)}   className="hover:text-primary">
                                <svg
                                    className="fill-current"
                                    width="18"
                                    height="18"

...
const Vendor = () => {
  ...
  const getVendors = () => {
    ...
    axios
      .get(baseUrl + `vendor/?pageNumber=${Page}&pageSize=${pageSize}`)
      .then((res) => {
        console.log(res.data.object);
        setVendorData(res.data.object);
      })
      .catch((err) => {
        console.log(err);
      });

  ...
  return (
    <DefaultLayout>
      ...
      <div className="overflow-hidden">
        ...
        {/* ---------------------------------- this is card for test ------------------------- */}
        <div className="flex flex-wrap ">
          {/* Card 1 */}
          <div className="max-w-md mx-auto bg-white rounded-md overflow-hidden shadow-md min-w-[350px] mb-6 p-1">
            <div className="flex justify-between items-center bg-gray-100 px-4 py-2">
              <span className="font-semibold text-gray-800">ID: 875</span>
            ...
            <div className="p-4">
              ...
              <p className="text-gray-700 mb-2">customer@example.com</p>
              <p className="text-gray-700 mb-4">1234567890</p>
              <div className="flex justify-between">
                <button className="text-sm text-white bg-blue-500 px-3 py-1 rounded-md hover:bg-blue-600">
                  View
                </button>
                <button className="text-sm text-white bg-meta-3 px-3 py-1 rounded-md hover:bg-opacity-90">
                  Update
                </button>
              </div>
            </div>

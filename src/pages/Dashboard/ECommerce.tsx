        ...
        <>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
            ...
            <CardDataStats
              ...
              total={data.AverageOrderProcessingTime}
              rate="0.43%"
              levelUp
            >
              <svg
            ...
            <CardDataStats
              title="Total Sales"
              total={formatNumber(data.CalculateTotalSales)}
              rate="4.35%"
              levelUp
            >
              <svg
            ...
            <CardDataStats
              title="Total Orders"
              total={formatNumber(data.TotalOrder)}
              rate="2.59%"
              levelUp
            >
              <svg
            ...
            <CardDataStats
              ...
              total={data.CustomerRetentionRate.toFixed(1)}
              rate="0.95%"
              levelDown
            >
              <svg
          ...
          <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
            ...
            <MonthlySaleChart monthlySale={monthlySale} />
            ...
            <WeeklyOrdersChart weeklyOrders={weeklyOrders} />

            {/* ----------------------------------------- Status Chart --------------------------------- */}
            <StatusChart StatusKey={StatusKey} StatusVal={StatusVal} />

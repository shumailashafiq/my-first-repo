  ...
  return (
    <DefaultLayout>
      ...
      <div className="flex flex-col">
        <div
          className={`h-full w-full flex justify-center items-center z-20 ${display3} `}
        >
          <SingleFranchisee
        ...
        <div
          className={`h-full w-full flex justify-center  items-center relative ${display4} `}
        >
          <UpdateFranchisee
        ...
        >
          <button
            ...
            className="p-3 px-4 shadow-md shadow-black  bg-blue-500 rounded fixed z-10 text-white bottom-[20px] right-[20px] text-3xl"
          >
            +
          </button>
                    ...
                    <tr key={key}>
                      ...
                      <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                        <div className="flex items-center space-x-3.5">
                          ...
                          <button
                            onClick={() =>
                              deleteHandler(franchisees.franchisee_id, key)
                            }
                            className="hover:text-primary"
                          >
                            <svg
                          ...
                          <button
                            onClick={() => UpdateHandler(franchisees)}
                            className="hover:text-primary"
                          >
                            <svg
                              className="fill-current"

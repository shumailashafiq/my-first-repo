...
const SignUp: React.FC = () => {
  return (
    <div className="rounded-sm border  h-dvh overflow-hidden border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      <div className="flex flex-wrap  justify-center items-center">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 ">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            <span className="mb-1.5 block font-medium">Start here</span>
